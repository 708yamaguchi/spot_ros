...
def GetOdomFromState(state, spot_wrapper):
    ...
    pose_odom_msg.pose.position.x = tform_body.linear.x
    pose_odom_msg.pose.position.y = tform_body.linear.y
    pose_odom_msg.pose.position.z = tform_body.linear.z
    pose_odom_msg.pose.orientation.x = tform_body.angular.x
    pose_odom_msg.pose.orientation.y = tform_body.angular.y
    pose_odom_msg.pose.orientation.z = tform_body.angular.z
