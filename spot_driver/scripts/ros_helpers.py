...
def GetOdomFromState(state, spot_wrapper):
    ...
    pose_odom_msg.pose.position.x = tform_body.linear.position.x
    pose_odom_msg.pose.position.y = tform_body.linear.position.y
    pose_odom_msg.pose.position.z = tform_body.linear.position.z
